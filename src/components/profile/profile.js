    ...
    <Grid container spacing={2}>
      ...
      <Grid item xs={12} md={8}>
        ...
        <Typography variant="body1" gutterBottom>
          ...
          nisi luctus, tempor risus vel, tristique nibh. Nunc pellentesque
          velit lectus, eget efficitur purus elementum ac. Etiam non mauris
          eget mauris pellentesque euismod.
        </Typography>
